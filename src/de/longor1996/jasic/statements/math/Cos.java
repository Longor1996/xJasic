...
public class Cos extends BasicMathStatement
{
	public Cos(Jasic jasic, String output, Expression input) {
		super(jasic, output, input);
	}
	
	@Override public Value calc(Value evaluationResult) {
		return new NumberValue(Math.cos(evaluationResult.toNumber()));
	}
}