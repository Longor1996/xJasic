...
public class ASin extends BasicMathStatement
{
	public ASin(Jasic jasic, String output, Expression input) {
		super(jasic, output, input);
	}
	
	@Override public Value calc(Value evaluationResult) {
		return new NumberValue(Math.asin(evaluationResult.toNumber()));
	}
}